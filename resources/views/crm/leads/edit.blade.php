...
@section('title', 'Edit Lead | CRM - PHPKolkata')

@section('content')

<div class="page">
	<div class="page-header">
		<h1 class="page-title">Edit lead - {{ $data->lead_id }}</h1>
			...
			<div class="col-md-8">
				...
				<div class="panel">
					<div class="panel-body container-fluid">
						...
						<form method="post" action="{{ route('lead.update', $data->id) }}" autocomplete="off" onsubmit="return validateLeadForm()">
							@csrf
							...
							<div class="row">
								<div class="form-group form-material col-md-6" data-plugin="formMaterial">
									...
									<input type="text" class="form-control" id="business_name" name="business_name" placeholder="Business Name" value="{{ $data->business_name }}" autofocus />
							...
							<div class="row">
								<div class="form-group form-material col-md-6" data-plugin="formMaterial">
									...
									<textarea class="form-control" name="location" id="location" cols="30" rows="3" placeholder="Location">{{ $data->location }}</textarea>
							...
							<div class="row">
								<div class="form-group form-material col-md-6" data-plugin="formMaterial">
									...
									<input type="text" class="form-control" id="contact_person" name="contact_person" placeholder="Contact person" value="{{ $data->contact_person }}" onkeyup="return letterswithspace(this)" />
								...
								<div class="form-group form-material col-md-6" data-plugin="formMaterial">
									...
									<input type="text" class="form-control" id="job_title" name="job_title" placeholder="Job title" value="{{ $data->job_title }}" />
							...
							<div class="row">
								<div class="form-group form-material col-md-6" data-plugin="formMaterial">
									...
									<input type="text" class="form-control" id="contact_no" name="contact_no" placeholder="Contact person" value="{{ $data->contact_no }}" onkeyup="return numbersonly(this), fillWA()" />
								...
								<div class="form-group form-material col-md-6" data-plugin="formMaterial">
									...
									<input type="text" class="form-control" id="whatsapp_no" name="whatsapp_no" placeholder="WhatsApp no." value="{{ $data->whatsapp_no }}" onkeyup="return numbersonly(this)" />
							...
							<div class="row">
								...
								<div class="form-group form-material col-md-6" data-plugin="formMaterial">
									...
									<input type="text" class="form-control" id="lead_source" name="lead_source" placeholder="Lead source" value="{{ $data->lead_source }}" />
							...
							<div class="row">
								<div class="form-group form-material col-md-6" data-plugin="formMaterial">
									...
									<select name="assign_to" id="assign_to" class="form-control" data-plugin="select2" data-placeholder="Select user" data-allow-clear="true">
										...
										<option value="{{ $user->id }}" @if ($data->assign_to==$user->id)@selected(true)@endif>{{ $user->name }}</option>
										@endforeach
									</select>
							...
							<div class="row">
								<div class="form-group form-material col-md-6" data-plugin="formMaterial">
									...
									<textarea class="form-control" name="notes" id="notes" cols="30" rows="3" placeholder="Notes">{{ $data->notes }}</textarea>
							...
							<div class="row">
								<div class="form-group form-material col-md-6" data-plugin="formMaterial">
									...
									<div class="form-check form-check-inline mr-10">
										<input class="form-check-input" type="radio" name="lead_type" id="lead_type_{{ $leadType->id }}" value="{{ $leadType->id }}" @if ($data->lead_type==$leadType->id)@checked(true)@endif>
								...
								<div class="form-group form-material col-md-6" data-plugin="formMaterial">
									...
									<div class="form-check form-check-inline mr-10">
										<input class="form-check-input" type="radio" name="action" id="action_{{ $action->id }}" value="{{ $action->id }}" @if ($data->action==$action->id)@checked(true)@endif>
							...
							<div class="row mt-30">
								<button type="submit" class="btn btn-primary btn-sm mr-20">Save Changes</button>
