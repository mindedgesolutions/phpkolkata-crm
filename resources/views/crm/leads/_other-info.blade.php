	...
	<li class="list-group-item">
		<div class="profile-brief">
			<table class="table table-striped table-hover col-md-6">
				...
				<tr>
					<td class="col-md-3">Assign/ed to :</td>
					<td class="col-md-8">
						<select name="assignTo" id="assignTo" class="form-control" data-plugin="select2" data-placeholder="Select assign to" data-allow-clear="true" onchange="assignUserFromView()">
							<option value=""></option>
