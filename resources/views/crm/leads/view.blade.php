...
@section('title', 'View Lead | CRM - PHPKolkata')
	...
	<div class="page-header">
		...
		<div class="page-header-actions">
			<div class="btn-group btn-group-sm">
				<a href="javascript:void(0)" data-target="#annotation" data-toggle="modal"><button type="button" class="btn btn-success btn-sm mr-10">Add annotation</button></a>
				<a href="{{ route('lead.index') }}"><button type="button" class="btn btn-default btn-sm">Back to list</button></a>
			</div>
		</div>
	</div>

	@include('crm.leads.annotation-modal')
