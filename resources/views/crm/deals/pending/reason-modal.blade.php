<div class="modal fade" id="reason" aria-hidden="true" aria-labelledby="reason" role="dialog">
	<div class="modal-dialog modal-simple modal-top">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="exampleModalTitle">End status</h4>
			</div>
			...
			<div class="modal-footer mt-30">
				...
				<button type="button" class="btn btn-primary btn-sm" onclick="approveDeal(0, {{ $data->id }})">Save changes</button>
			</div>
		</div>
	</div>
</div>