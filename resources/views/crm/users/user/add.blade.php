...
@section('title', 'Add User | CRM - PHPKolkata')
			...
			<div class="col-md-8">
				...
				<div class="panel">
					<div class="panel-body container-fluid">
						...
						<form method="post" action="{{ route('user.store') }}" autocomplete="off" onsubmit="return validateFormUser()">
							@csrf
												...
												<td class="col-2">
													<div class="checkbox-custom checkbox-primary float-left">
														<input type="checkbox" name="access[]" 
																										id="list_{{ $menu->id }}" 
																										value="list_{{ $menu->id }}" /><label></label>
													</div>
												</td>
