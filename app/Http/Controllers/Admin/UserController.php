...
class UserController extends Controller
{
	...
	{
		$users = User::where('role', 3)->where('active', true)->orderBy('name')->paginate(10);

		return view('crm.users.user.index', compact('users'));
	}
	...
	public function create()
	{
		...
		return view('crm.users.user.add', compact('menus'));
	}
	...
	public function edit($id)
	{
		...
		return view('crm.users.user.edit', compact('data', 'menus'));
	}
	...
	// 	AccessModel::where('user_id', $request->userId)->where('menu_id', $request->menuId)->update([
	// 		'p_list' => false,
	// 		'p_read' => false,
	// 		'p_write' => false,
	// 		'p_delete' => false,
